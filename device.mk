...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/misound_res_headphone.bin:$(TARGET_COPY_OUT_VENDOR)/etc/misound_res_headphone.bin \
    $(LOCAL_PATH)/audio/misound_res_spk.bin:$(TARGET_COPY_OUT_VENDOR)/etc/misound_res_spk.bin \
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/rootdir/etc/fstab.mt6781:$(TARGET_VENDOR_RAMDISK_OUT)/first_stage_ramdisk/fstab.mt6781
